//! Basic 8x8 Bitmap Font (IBM VGA / Code Page 437 style)
//! Covers ASCII 0x00 - 0x7F
...
// 128 chars * 8 bytes = 1024 bytes
#[rustfmt::skip]
pub const FONT: [[u8; 8]; 128] = [
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], // 0x00 (NUL)
    [0x7E, 0x81, 0xA5, 0x81, 0xBD, 0x99, 0x81, 0x7E], // 0x01 (SOH) - Smiley
    [0x7E, 0xFF, 0xDB, 0xFF, 0xC3, 0xE7, 0xFF, 0x7E], // 0x02 (STX) - Filled Smiley
    ...
    [0x18, 0x38, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00], // 0x31 1
    ...
    [0x3C, 0x60, 0x7C, 0x66, 0x66, 0x66, 0x3C, 0x00], // 0x36 6
    [0x7E, 0x06, 0x0C, 0x18, 0x30, 0x30, 0x30, 0x00], // 0x37 7
    [0x3C, 0x66, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00], // 0x38 8
    [0x3C, 0x66, 0x66, 0x66, 0x3E, 0x06, 0x3C, 0x00], // 0x39 9
    ...
    [0x1C, 0x20, 0x7C, 0x20, 0x20, 0x20, 0x20, 0x00], // 0x66 f
    ...
    [0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x38, 0x00], // 0x6C l
    ...
    [0x00, 0x00, 0x5C, 0x62, 0x60, 0x60, 0x60, 0x00], // 0x72 r
    [0x00, 0x00, 0x3C, 0x60, 0x3C, 0x06, 0x3C, 0x00], // 0x73 s
    [0x20, 0x20, 0x7C, 0x20, 0x20, 0x20, 0x1C, 0x00], // 0x74 t
    [0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x3E, 0x00], // 0x75 u
    [0x00, 0x00, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x00], // 0x76 v
    [0x00, 0x00, 0x63, 0x6B, 0x7F, 0x6B, 0x63, 0x00], // 0x77 w
